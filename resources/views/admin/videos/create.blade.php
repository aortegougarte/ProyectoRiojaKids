    ...
    <div class="kids-card p-3">
        <form method="POST" action="{{ route('admin.videos.store') }}">
            ...
            <div class="mb-3">
                ...
                <div class="text-muted small mt-1">Es lo que va después de <code>v=</code> en la URL.</div>
            </div>
            ...
            <div class="mb-3 mt-3">
                ...
                <textarea class="form-control" rows="4" name="description" placeholder="¿Qué aprenderán los peques con este vídeo?"></textarea>
            </div>
